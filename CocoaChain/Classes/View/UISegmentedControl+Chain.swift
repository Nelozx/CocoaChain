...
public extension CocoaChain where ObjectType: UISegmentedControl {
    
    // if set, then we don't keep showing selected state after tracking ends. default is NO
    @discardableResult
    func isMomentary(_ isMomentary: Bool) -> CocoaChain {
    ...
    @discardableResult
    func apportionsSegmentWidthsByContent(_ apportion: Bool) -> CocoaChain {
        self.chain.apportionsSegmentWidthsByContent = apportion
        return self
    }
    
    @discardableResult
    func insertSegment(withTitle title: String?, at segment: Int, animated: Bool) -> CocoaChain {
        self.chain.insertSegment(withTitle: title, at: segment, animated: animated)
        return self
    }
    
    @discardableResult
    func insertSegment(with image: UIImage?, at segment: Int, animated: Bool) -> CocoaChain {
        self.chain.insertSegment(with: image, at: segment, animated: animated)
        return self
    }
    
    @discardableResult
    func removeSegment(at segment: Int, animated: Bool) -> CocoaChain {
        self.chain.removeSegment(at: segment, animated: animated)
        return self
    }
    
    @discardableResult
    func removeAllSegments() -> CocoaChain {
    ...
    @discardableResult
    func setTitle(_ title: String?, forSegmentAt segment: Int) -> CocoaChain {
    ...
    @discardableResult
    func setImage(_ image: UIImage?, forSegmentAt segment: Int) -> CocoaChain {
    ...
    @discardableResult
    func setWidth(_ width: CGFloat, forSegmentAt segment: Int) -> CocoaChain {
    ...
    @discardableResult
    func setContentOffset(_ offset: CGSize, forSegmentAt segment: Int) -> CocoaChain {
    ...
    @discardableResult
    func setEnabled(_ enabled: Bool, forSegmentAt segment: Int) -> CocoaChain {
        self.chain.setEnabled(enabled, forSegmentAt: segment)
        return self
    }
    
    @discardableResult
    func selectedSegmentIndex(_ selectedSegmentIndex: Int) -> CocoaChain {
    ...
    @discardableResult
    func setBackgroundImage(_ backgroundImage: UIImage?, for state: UIControl.State, barMetrics: UIBarMetrics) -> CocoaChain {
     ...
     */
    @discardableResult
    func setDividerImage(_ dividerImage: UIImage?, forLeftSegmentState leftState: UIControl.State, rightSegmentState rightState: UIControl.State, barMetrics: UIBarMetrics) -> CocoaChain {
     ...
     */
    @discardableResult
    func setTitleTextAttributes(_ attributes: [NSAttributedString.Key : Any]?, for state: UIControl.State) -> CocoaChain {
     ...
     */
    @discardableResult
    func setContentPositionAdjustment(_ adjustment: UIOffset, forSegmentType leftCenterRightOrAlone: UISegmentedControl.Segment, barMetrics: UIBarMetrics) -> CocoaChain {
